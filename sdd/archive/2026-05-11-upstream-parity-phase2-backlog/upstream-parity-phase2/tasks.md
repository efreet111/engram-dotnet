...
- [x] 1.5 GREEN: `DeleteSessionAsync(id)` in SqliteStore — check exists, check observations, soft-delete prompts, hard-delete session
...
- [x] 1.8 GREEN: `DeletePromptAsync(id)` in SqliteStore — soft-delete in prompt_tombstones
- [x] 1.9 GREEN: Implement `DeleteSessionAsync` and `DeletePromptAsync` in PostgresStore (same logic, PostgreSQL syntax)

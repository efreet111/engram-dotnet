...
| 17 | HU-026 | P0 | Bug | System.CommandLine 2.0.0-beta4.22272.1 → 2.0.11: API cambió, causa CS1061 al compilar. El binary pre-built tiene bug de runtime en middleware. | Ready | M | error install 2026-08-20 | `docs/tasks/HU-001-HU-099/HU-026-system-commandline-migration.md` — requiere actualizar código Program.cs para API 2.0.11 (AddCommand, InvokeAsync) |

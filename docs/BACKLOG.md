...
| 56 | ENG-476 | P1 | Feature | **Sync-on-demand**: cuando el sync está habilitado pero nadie lo arranca, las memorias están desincronizadas y el usuario no lo sabe. Trigger sync cycle cuando el usuario hace búsqueda vía MCP/CLI. No requiere daemon. | Idea | S | ← sesión sync 2026-07-25 | Engagement: mem_search, mem_context, mem_get. Fire-and-forget, no bloquea query. |
